...
gantt
    ...
    M4 多Agent + Worktree    :m4a, 2026-08, 2026-09
...
| [M4](M4.md) | 并发 | 多 Agent 并发、worktree 隔离、哈希冲突弹窗 | 当前阶段 |
